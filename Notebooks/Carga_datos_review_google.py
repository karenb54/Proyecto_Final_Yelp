...
LOCAL_DATASETS_DIR = r"/run/media/hugo/06368a0d-700b-4ac5-9159-173c295dcaed/Google/reviews-estados"

# Configuración de Google Cloud Storage (GCS)
BUCKET_NAME = "bucket-proyecto-final-1"
REMOTE_DATASETS_DIR = "datos-crudos/Google/Review/"  # Review
...
def convert_and_upload_to_gcs():
    ...
    parquet_file_path = os.path.join(LOCAL_DATASETS_DIR, 'Review')
